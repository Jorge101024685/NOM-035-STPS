...
<body>
 ...
 <h4>Identificación y Análisis de los Factores de Riesgo Psicosocial y Evaluación del Entorno Organizacional</h4>
 ...
 //se abre php  
	 ...
	 include("../bd/abrir_bd.php");
      ...
      $consul= "SELECT codigo,fecha,empresa,dom1,cdom1,dom2,cdom2,dom3,cdom3,dom4,cdom4,dom5,cdom5,dom6,cdom6,dom7,cdom7,dom8,cdom8,dom9,cdom9,dom10,cdom10,cat1,ccat1,cat2,ccat2,cat3,ccat3,cat4,ccat4,cat5,ccat5,calificacion, nivel_riesgo FROM $tabla3 INNER JOIN empresa ON $tabla3.id_empresa=empresa.id_empresa WHERE $tabla3.id_empresa=$cct ORDER BY nivel_riesgo";                                                                                                                                                                                                                                                           
      $resultados = mysqli_query($conexion,$consul);
	  
	  
	  $consul2="SELECT COUNT(*) as grupo, nivel_riesgo FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY nivel_riesgo";
     $resultados2= mysqli_query($conexion,$consul2);
	  
	  
	  
	  
     $consul3="SELECT COUNT(*) as suma1, cdom1 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY cdom1";
     $resultados3= mysqli_query($conexion,$consul3);

    
     $consul4="SELECT COUNT(*) as suma2, cdom2 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY cdom2";
     $resultados4= mysqli_query($conexion,$consul4);
    
    
    $consul5="SELECT COUNT(*) as suma3, cdom3 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY cdom3";
     $resultados5= mysqli_query($conexion,$consul5);
  
   
    $consul6="SELECT COUNT(*) as suma4, cdom4 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY cdom4";
     $resultados6= mysqli_query($conexion,$consul6);

   
    $consul7="SELECT COUNT(*) as suma5, cdom5 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY cdom5";
     $resultados7= mysqli_query($conexion,$consul7);
     
     
    $consul8="SELECT COUNT(*) as suma6, cdom6 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY cdom6";
     $resultados8= mysqli_query($conexion,$consul8);

     
    $consul9="SELECT COUNT(*) as suma7, cdom7 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY cdom7";
     $resultados9= mysqli_query($conexion,$consul9);  

   
    $consul10="SELECT COUNT(*) as suma8, cdom8 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY cdom8";
     $resultados10= mysqli_query($conexion,$consul10);


    $consul15="SELECT COUNT(*) as suma13, cdom9 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY cdom9";
     $resultados15= mysqli_query($conexion,$consul15);  

   
    $consul16="SELECT COUNT(*) as suma14, cdom10 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY cdom10";
     $resultados16= mysqli_query($conexion,$consul16);
    



    
    $consul11="SELECT COUNT(*) as suma9, ccat1 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY ccat1";
     $resultados11= mysqli_query($conexion,$consul11);
    
    
    $consul12="SELECT COUNT(*) as suma10, ccat2 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY ccat2";
     $resultados12= mysqli_query($conexion,$consul12);

    
    $consul13="SELECT COUNT(*) as suma11, ccat3 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY ccat3";
     $resultados13= mysqli_query($conexion,$consul13);

     
    $consul14="SELECT COUNT(*) as suma12, ccat4 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY ccat4";
     $resultados14= mysqli_query($conexion,$consul14);

   
    $consul17="SELECT COUNT(*) as suma15, ccat5 FROM $tabla3 WHERE $tabla3.id_empresa=$cct GROUP BY ccat5";
     $resultados17= mysqli_query($conexion,$consul17);
	  
	
	
	$consultartotal="SELECT COUNT(*) as total FROM $tabla3 WHERE $tabla3.id_empresa=$cct";
   ...
   ?>
  	   <table>
          ...
          <tr>
            ...
            <th></th>
			<th></th>
            <th colspan="10" style="color: yellow; background: green;">Dominios</th>
            <th colspan="5" style="color: yellow; background: orange;">Categorias</th>
	    ...
	    <tr>
		  ...
		  <th style="color: yellow; background: green;">Reconocimiento del Desempeño</th>
		 
		  <th style="color: yellow; background: green;">Insuficiente Sentido de Pertenencia</th>
		  ...
		  <th style="color: yellow; background: orange;">Entorno Organizacional</th>
         ...
         while($consulta = mysqli_fetch_array($resultados, MYSQLI_ASSOC))
           {
			 ...
			 $dom9[$c]=$consulta["dom9"];
             $dom10[$c]=$consulta["dom10"];
...
while($consulta10 = mysqli_fetch_array($resultados10, MYSQLI_ASSOC))
 ...
 $p=0;
while($consulta15 = mysqli_fetch_array($resultados15, MYSQLI_ASSOC))
           {
             $cdom9[$p]=$consulta15['cdom9'];
             $suma13[$p]=$consulta15['suma13'];
             if($cdom9[$p]=="alto"){
             $color13[$p]='#e0b241'; 
             }
             if($cdom9[$p]=="bajo"){
 ...
 $q=0;
while($consulta16 = mysqli_fetch_array($resultados16, MYSQLI_ASSOC))
           {
             $cdom10[$q]=$consulta16['cdom10'];
             $suma14[$q]=$consulta16['suma14'];
             if($cdom10[$q]=="alto"){
             $color14[$q]='#e0b241'; 
             }
             if($cdom10[$q]=="bajo"){
...
while($consulta14 = mysqli_fetch_array($resultados14, MYSQLI_ASSOC))
 ...
 $s=0;
while($consulta17 = mysqli_fetch_array($resultados17, MYSQLI_ASSOC))
           {
             $ccat5[$s]=$consulta17['ccat5'];
             $suma15[$s]=$consulta17['suma15'];
             if($ccat5[$s]=="alto"){
             $color15[$s]='#e0b241'; 
             }
             if($ccat5[$s]=="bajo"){
       ...
       <?php
		   echo " <tr>
                       ...
                       <td><input type='text' name='dom9' value='$dom9[$j]' size='3' readonly style='border:0;'></td>
                       <td><input type='text' name='dom10' value='$dom10[$j]' size='3' readonly style='border:0;'></td>
					   ...
					   <td><input type='text' name='cat5' value='$cat5[$j]' size='3' readonly style='border:0;'></td>
                      <td>".$calif[$j]."</td> 
                      <td>".$nivel[$j]."</td>";
					  if($j==0)
				      {
                 ...
                 ?>
                   ...
                   <input type="text" name="cdom1" value="<?php echo $cdom1[$j];?>" size='1' readonly class="clasi">
                      ...
                      <input type="text" name="cdom9" value= "<?php echo $cdom9[$j];?>" size='1' readonly class="clasi">
                      <input type="text" name="cdom10" value="<?php echo $cdom10[$j];?>" size="1" class="clasi"> 
                      ...
                      <input type="text" name="ccat5" value="<?php echo $ccat5[$j];?>" size="1" class="clasi">
...
<div id="dominio9" style="width: 410px; height: 400px;"></div>
    ...
    $('#dominio9').highcharts({
        ...
        series: [{
            ...
            data: [
                         <?php for($x=0;$x<=$p-1;$x++){?>   
                    {
                         name:<?php echo "'".$cdom9[$x]."'";?>,
                   y:<?php echo $suma13[$x];?>,   
                   color:<?php echo "'".$color13[$x]."'";?>,
                 },
                     <?php } ?>
                ]
        }]
...
<div id="dominio10" style="width: 410px; height: 400px;"></div>
    
        <script type="text/javascript">
$(function () {
    $('#dominio10').highcharts({
        chart: {
            plotBackgroundColor: null,
            plotBorderWidth: null,
            plotShadow: false
        ...
        title: {
            text: 'Insuficiente Sentido de Pertenencia'
        },
     ...
     credits:{
        ...
        series: [{
            ...
            data: [
                         <?php for($x=0;$x<=$q-1;$x++){?>   
                    {
                         name:<?php echo "'".$cdom10[$x]."'";?>,
                   y:<?php echo $suma14[$x];?>,   
                   color:<?php echo "'".$color14[$x]."'";?>,
                 },
                     <?php } ?>
                ]
        }]
...
<div id="categoria5" style="width: 410px; height: 400px;" ></div>
    
        <script type="text/javascript">
$(function () {
    $('#categoria5').highcharts({
        chart: {
            plotBackgroundColor: null,
            plotBorderWidth: null,
            plotShadow: false
        ...
        series: [{
            ...
            data: [
                         <?php for($x=0;$x<=$s-1;$x++){?>   
                    {
                         name:<?php echo "'".$ccat5[$x]."'";?>,
                   y:<?php echo $suma15[$x];?>,   
                   color:<?php echo "'".$color15[$x]."'";?>,
                 },
                     <?php } ?>
                ]
        }]
