 ...
 //se abre php  
  ...
  <script type="text/javascript">
		$(function () {
			...
			categories = ['Ambiente de Trabajo','Factores Propios de la Actividad','Org. del Tiempo del Trabajo','Liderazgo y Relaciones en el Trabajo'],
  ...
  <script type="text/javascript">
		$(function () {
			var colors = Highcharts.getOptions().colors,
			categories = ['Condiciones en el Ambiente de Trabajo','Carga de Trabajo','Falta de Control Sobre el Trabajo','Jornada de Trabajo','Interferencia Relacion Trabajo-Familia','Liderazgo','Rel en el Trabajo','Violencia'],
			name = '<?php echo $codigo;?>',
			data = [<?php for($x=0;$x<8;$x++){?>	
			{
				y: <?php echo $dom[$x]?>,
